...
func (h *handler) CreateSpecialization(w http.ResponseWriter, r *http.Request) {
	...
	logger.InfoContext(ctx, "Handler: Processing create specialization request",
		"operation", "create_specialization",
		"method", r.Method,
		"path", r.URL.Path,
		"user_agent", r.Header.Get("User-Agent"))

	// Parse request body
	var request domain.CreateSpecializationRequest
	...
	// Call service to create specialization
	specialization, err := h.svc.CreateSpecialization(ctx, &request)
	if err != nil {
		...
		switch logLevel {
		case "warn":
			logger.WarnContext(ctx, "Handler: Create specialization failed", logFields...)
		case "error":
			logger.ErrorContext(ctx, "Handler: Create specialization failed", logFields...)
		}
	...
	logger.InfoContext(ctx, "Handler: Create specialization completed",
		"operation", "create_specialization",
		"method", r.Method,
		"path", r.URL.Path,
