...
import (
	...
	availabilityRepository "github.com/Leviosa-care/leviosa/backend/internal/booking/infrastructure/postgres/availability"
...
func TestMain(m *testing.M) {
	...
	repo = availabilityRepository.New(ctx, testPool)
	if err != nil {
