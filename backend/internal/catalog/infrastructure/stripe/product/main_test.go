...
var (
	...
	stripeService   ports.ProductPaymentGateway
)
...
func TestMain(m *testing.M) {
	...
	stripeService = productPayment.NewProduct("sk_test_123456789012345678901234", stripeContainer.URL)
	log.Println("Stripe product service initialized with mock container")
