...
import (
	...
	"github.com/Leviosa-care/leviosa/backend/internal/catalog/infrastructure/postgres/shared"
...
func TestMain(m *testing.M) {
	...
	repo = sharedRepository.New(ctx, testPool)
