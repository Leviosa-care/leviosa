...
type SessionRepository interface {
	...
	RefreshTokenPair(ctx context.Context, oldRefreshTokenHash, oldAccessTokenHash, newAccessTokenHash, newRefreshTokenHash string, sessionID uuid.UUID, updatedSessionData []byte, accessTTL, refreshTTL time.Duration) error
