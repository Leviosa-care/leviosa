...
func (h *handler) GetUser(w http.ResponseWriter, r *http.Request) {
	...
	logger.InfoContext(ctx, "Handler: Processing get user request",
		"operation", "get_user",
		"method", r.Method,
		"path", r.URL.Path,
	...
	user, err := h.svc.GetUserByID(ctx, sessionInfo.UserID)
	if err != nil {
		...
		switch logLevel {
		case "warn":
			logger.WarnContext(ctx, "Handler: Get user failed", logFields...)
		case "error":
			logger.ErrorContext(ctx, "Handler: Get user failed", logFields...)
		}
	...
	logger.InfoContext(ctx, "Handler: Get user completed",
		"operation", "get_user",
		"method", r.Method,
		"path", r.URL.Path,
		"user_id", sessionInfo.UserID,
