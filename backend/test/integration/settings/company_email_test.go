...
// make test-func TEST_NAME=TestGetCompanyEmail TEST_PATH=test/integration/settings/company_email_test.go
...
// make test-func TEST_NAME=TestSetCompanyEmail TEST_PATH=test/integration/settings/company_email_test.go
...
func TestSetCompanyEmail(t *testing.T) {
	...
	t.Run("should successfully set company email", func(t *testing.T) {
		...
		email, err := th.GetCompanyEmail(t, ctx, testPool)
		require.NoError(t, err)
