...
// make test-func TEST_NAME=TestGetCompanyPhone TEST_PATH=test/integration/settings/company_phone_test.go
...
// make test-func TEST_NAME=TestSetCompanyPhone TEST_PATH=test/integration/settings/company_phone_test.go
...
func TestSetCompanyPhone(t *testing.T) {
	...
	t.Run("should successfully set company phone", func(t *testing.T) {
		...
		phoneSettingEncx := th.GetEncryptedSetting(t, ctx, settings.CompanyPhone, testPool)
