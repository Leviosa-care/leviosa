...
// make test-func TEST_NAME=TestGetCompanyName TEST_PATH=test/integration/settings/company_name_test.go
...
// make test-func TEST_NAME=TestSetCompanyName TEST_PATH=test/integration/settings/company_name_test.go
...
func TestSetCompanyName(t *testing.T) {
	...
	t.Run("should successfully set company name", func(t *testing.T) {
		...
		retrievedName, err := th.GetCompanyName(t, ctx, testPool)
		require.NoError(t, err)
	...
	t.Run("should successfully update existing company name", func(t *testing.T) {
		...
		name, err := th.GetCompanyName(t, ctx, testPool)
		require.NoError(t, err)
