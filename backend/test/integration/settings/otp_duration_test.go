...
// make test-func TEST_NAME=TestGetOTPDuration TEST_PATH=test/integration/settings/otp_duration_test.go
...
// make test-func TEST_NAME=TestSetOTPDuration TEST_PATH=test/integration/settings/otp_duration_test.go
...
func TestSetOTPDuration(t *testing.T) {
	...
	t.Run("should successfully set OTP duration", func(t *testing.T) {
		...
		retrievedDuration, err := th.GetOTPDuration(t, ctx, testPool)
		require.NoError(t, err)
