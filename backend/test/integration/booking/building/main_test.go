...
func TestMain(m *testing.M) {
	...
	serviceNames := []string{services.Booking} // Only settings service for this test
	...
	repo = buildingPostgres.New(ctx, testPool)
	service = buildingService.New(repo, crypto)
	...
	handler = buildingHandler.New(service, authmw)
