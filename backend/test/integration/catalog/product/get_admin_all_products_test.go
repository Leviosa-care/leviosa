...
func TestGetAdminAllProducts(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "should return products with prices and images",
			setupData: func(t *testing.T, ctx context.Context) {
				// Clean tables first
				td.ClearProductsTable(t, ctx, testPool)
				td.ClearPricesTable(t, ctx, testPool)
		...
		{
			name: "should return products without prices or images",
			setupData: func(t *testing.T, ctx context.Context) {
				// Clean tables
				td.ClearProductsTable(t, ctx, testPool)
				td.ClearPricesTable(t, ctx, testPool)
		...
		{
			name: "should return products with only inactive images (no images in response)",
			setupData: func(t *testing.T, ctx context.Context) {
				// Clean tables
				td.ClearProductsTable(t, ctx, testPool)
				td.ClearPricesTable(t, ctx, testPool)
		...
		{
			name: "should handle multiple products with mixed data",
			setupData: func(t *testing.T, ctx context.Context) {
				// Clean tables
				td.ClearProductsTable(t, ctx, testPool)
				td.ClearPricesTable(t, ctx, testPool)
...
func TestGetAdminAllProducts_ResponseFormat(t *testing.T) {
	ctx := context.Background()
	...
	// assert.NotNil(t, products[0].Prices) // Should be empty slice, not nil
