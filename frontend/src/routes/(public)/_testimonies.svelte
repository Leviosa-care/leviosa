        ...
        <div class="flex flex-col items-center justify-center" use:reveal={{ preset: "fade-up", delay: 200 }}>
            <div class="flex items-center gap-4 mb-2">
                <img
                    ...
                    alt="User"
                    class="w-12 h-12 rounded-full border border-dark-200 shadow-sm"
                />
                <div class="text-left">
        ...
        <div class="mt-10">
            ...
            >
                ...
                <svg
                    ...
                    data-width="16"
                    class="iconify group-hover:trandark-x-0.5 transition-transform text-dark-400 group-hover:text-dark-900 iconify--lucide"
                    ><path
                        fill="none"
                        stroke="currentColor"
                        stroke-linecap="round"
