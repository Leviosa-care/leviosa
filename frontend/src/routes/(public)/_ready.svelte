...
<section class="py-24 bg-dark-900 relative overflow-hidden">
    <!-- Background Glow -->
    <div
        class="absolute top-0 left-1/2 -trandark-x-1/2 w-full h-full max-w-3xl opacity-20 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-indigo-500 via-dark-900 to-dark-900 pointer-events-none"
    ></div>
