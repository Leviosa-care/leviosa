...
<div class="container mx-auto px-4 py-8 lg:py-12">
	...
	{#if data.weekEvents.length === 0}
		<div class="flex flex-col items-center justify-center py-16 text-center">
			...
			<h3 class="text-lg font-semibold text-foreground mb-2">Aucune donnée disponible</h3>
			<p class="text-muted-foreground max-w-md">
				Les données de planning ne sont pas encore disponibles.
				{#if filterStatus !== 'all'}
